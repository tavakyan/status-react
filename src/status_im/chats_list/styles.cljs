...
(def item-container
  (merge {:flex-direction :column
          ...
          :padding-right  16
          :flex           1}
         (get-in p/platform-specific [:component-styles :chat-list :item-container])))
...
(def new-messages-container
  (merge {:position        :absolute
          ...
          :borderRadius    50}
         (get-in p/platform-specific [:component-styles :chat-list :unread-count-container])))
