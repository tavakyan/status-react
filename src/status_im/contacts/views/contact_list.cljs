(ns status-im.contacts.views.contact-list
  ...
  (:require [re-frame.core :refer [subscribe dispatch dispatch-sync]]
            ...
            [status-im.components.toolbar.styles :refer [toolbar-background1 toolbar-inner]]
...
(defview contact-list-toolbar-edit [group]
  [toolbar {:style          toolbar-inner
            :nav-action     (act/back #(dispatch [:set-in [:contact-list-ui-props :edit?] false]))
            :title          (if-not group
                              (label :t/contacts)
